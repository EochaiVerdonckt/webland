            ...
            $('#calendar').fullCalendar( 'addEventSource',
                function(start, end, status, callback) {
                    ...
                    for (loop = start._d.getTime();
                        ...
                        var url = 'http://mobile-express.be/gesprek/agenda/conformVerlof.php?behandeling=';
                        ...
                        test_date5H.setHours(18);
                        test_date5H.setMinutes(30);
...
<h1 style="text-align: center">Hier kan je afspraken sluiten.</h1>
