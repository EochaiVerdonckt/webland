...
$path = getcwd();
$path = str_replace("doelgroep", "", $path);
...
if($_POST)
{
    ...
    $sql="INSERT INTO `doelgroep`( `naam`, `omschrijving`) VALUES ('".$_POST['naam']."','".$_POST['Comment']."')";
