...
if($_POST)
{
    ...
    $sql="INSERT INTO `members`(`info`, `omschrijving`) VALUES ('".$_POST['info']."','".$_POST['omschrijving']."')";
    ...
    if($_POST['depart2']){
        ...
        $depart=$depart['id'];
        $ctrl->updateStatement('members','departement',$depart,$last_id);
    }

    if($_POST['functie2']){
        $depart=getFunctie($ctrl,$_POST['functie2']);
        $depart=$depart['id'];
        $ctrl->updateStatement('members','functie',$depart,$last_id);
    }
...
function showOptions($ctrl,$title){
    echo "<div class='row'>";
      ...
      echo '<div style="text-align:left;"><label>Naam</label></div>';
      echo '<input type="text" class="form-control" name="info"/>';
      ...
      echo '<input type="hidden" class="form-control" name="depart" id="depart-hidden"/>
        ...
        echo '<input type="hidden" class="form-control" name="functie" id="depart-hidden"/>
        <div class="autocomplete" >
        <input type="text" class="form-control"  id="functiesInput" name="functie2"/>
        </div>
        ';  
...
<head lang="en">
    ...
    #functiesInputautocomplete-list{
        text-align: left;
    }
...
?>
 ...
 <script>
  ...
  autocomplete(document.getElementById("functiesInput"), data);
});
    </script>
</body>
</html>
