...
session_start();
$path = getcwd();
$path = str_replace("bussiness/mission", "", $path);
define ("FSPATH",$path);
...
function showOptions($ctrl,$title){
    $item=$ctrl->selectStatement('missie',"id=1");
    echo "<div class='row'>";
         $ctrl->side_nav();   
        echo "<div class='col-md-9' style=''>";
                ...
                echo '<div style="text-align:left;"><label>Pas hier uw missie aan</label></div>';
                echo '
 ...
 <script src="https://kit.fontawesome.com/ec86fc2ae0.js" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        ckfinder: {
            ...
            uploadUrl: 'https://webland.be/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images&responseType=json'
        }
    }  )
            .then( editor => {
