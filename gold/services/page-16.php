        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="/services/page-5.php" style="color: black;"><?php echo $services[4]['naam']?></a></li>
                        ...
                        <li style="padding-left: 0;"><a style="color: white;" class="page-scroll"  href="/privacy.php">Privacybeleid</a></li>
                         <li style="padding-left: 0;"><a style="color: white;" class="page-scroll"  href="https://www.facebook.com/For-Peace-of-Mind-and-Body-1010817622379103/"><i class="fa fa-facebook " target="_blank"></i></a></li>
...
<section id="services-section" class="page" style="background:url('/mysite/service-16.jpg'); background-size: cover;padding-top: 15%; padding-bottom: 10%;">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <a href="#" class="rotate-box-1 square-icon wow zoomIn animated" data-wow-delay="0" style="visibility: visible; animation-name: zoomIn;">
                                    ...
                                    <div  style="background: rgba(255,255,255,0.6); padding: 15px;">
                                        <h1 style="color: black;"><?php echo $services[15]['naam'] ?></h1>
  ...
  <section style="padding-top:100px;padding-bottom:100px;">
    <div class="container">
      <div class="row">
          <div style="">
                <?php echo $services[15]['omschrijving'] ?>      
          </div>
