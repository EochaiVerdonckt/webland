...
<body data-spy="scroll" data-target="#main-navbar">
  <div class="main" id="home">
   <?php $ctrl->print_nav(); ?>
<section id="services-section" class="page" style="background:url('/mysite/service-4.jpg'); background-size: cover;height:80vh;">
  ...
  <div class="container">
    <div class="row">
        <h2 class="text-center">Videogames</h2>
    </div><!-- row -->
  </div><!-- container -->
</div>
