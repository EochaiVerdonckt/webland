...
$services=getServices($ctrl);
    ...
    echo '</div>'; 
     ...
     echo '<div  class="row">';      
        printService($services[6]);    
        printService($services[7]);
        printService($services[8]);
    echo '</div>';
    
    
    echo '<div  class="row">';      
        printService($services[9]);    
        printService($services[10]);
        printService($services[11]);
    echo '</div>';
    
    
        echo '<div  class="row">';      
        printService($services[12]); 
           printService($services[13]);
            printService($services[14]);
    echo '</div>';
    
       echo '<div  class="row">';      
        printService($services[15]); 
        printService($services[16]);
        printService($services[17]);
    echo '</div>';
    
        echo '<div  class="row">';      
        printService($services[18]); 
        printService($services[19]);
        printService($services[20]);
    echo '</div>';
    
        echo '<div  class="row">';      
        printService($services[21]); 
         printService($services[22]); 
