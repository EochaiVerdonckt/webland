...
<section id="services-section" class="page" style="background:url('/mysite/service-15.jpg'); background-size: cover;padding-top: 15%; padding-bottom: 10%;">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <a href="#" class="rotate-box-1 square-icon wow zoomIn animated" data-wow-delay="0" style="visibility: visible; animation-name: zoomIn;">
                                    ...
                                    <div  style="background: rgba(255,255,255,0.6); padding: 15px;">
                                        <h1 style="color: black;"><?php echo $services[14]['naam'] ?></h1>
  ...
  <section style="padding-top:100px;padding-bottom:100px;">
    <div class="container">
      <div class="row">
          <div style="">
                <?php echo $services[14]['omschrijving'] ?>      
          </div>
