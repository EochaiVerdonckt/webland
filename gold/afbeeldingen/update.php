...
function showOptions($ctrl,$title){
    $item=$ctrl->selectStatement('artikel_balance',"id=".$_GET['id']);
    echo "<div class='row'>";
         $ctrl->side_nav();   
        echo "<div class='col-md-9' style=''>";
                ...
                echo '<div style="text-align:left;"><label>Pas hier de tekst aan</label></div>';
                 echo ' <textarea name="info" id="inleiding" class="form-control">'.$item['info'].'</textarea>';
