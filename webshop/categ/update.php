...
function showOptions($ctrl,$title){
    $item=$ctrl->selectStatement('catog',"id=".$_GET['id']);
    echo "<div class='row'>";
         $ctrl->side_nav();   
        echo "<div class='col-md-9' style=''>";
                ...
                echo '<div style="text-align:left;"><label>Pas hier uw tekst aan</label></div>';
    ...
    <div id="editor">'.$item['omschrijving'].'</div>
    <textarea name="omschrijving" id="backUp" style="display:none;">'.$item['omschrijving'].'</textarea>';
