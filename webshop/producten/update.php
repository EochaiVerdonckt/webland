...
function showOptions($ctrl,$title){
    $item=$ctrl->selectStatement('product',"id=".$_GET['id']);
    echo "<div class='row'>";
         $ctrl->side_nav();   
        echo "<div class='col-md-9' style=''>";
                ...
                echo  '<input type="text" name="prijs" value="'.$item['prijs'].'" class="form-control"/>';
                    echo '<div style="text-align:left;"><label>Pas hier het aantal aan</label></div>';
                echo  '<input type="text" name="aantal" value="'.$item['aantal'].'" class="form-control"/>';
