...
if($_POST)
{
    ...
    $sql="INSERT INTO `product`(`naam`, `omschrijving`, `aantal`, `prijs`, `catog`,  `merk`) VALUES ('".$_POST['naam']."','".$_POST['omschrijving']."','".$_POST['aantal']."','".$_POST['prijs']."','".$_POST['catog']."','".$_POST['merk']."')";
