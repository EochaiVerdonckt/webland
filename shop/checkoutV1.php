    ...
    <div class="container-fluid" style="height: 90vh;">
        <div class="row" style="margin-top: 12px;">
            <div class="text-center">
                <h1 style=" color: #117CCA;">UW BESTELLING</h1>
            </div>
        </div>
            ...
            <div class="col-md-10">
              <?php
                    ...
                    for ($i = 1; $i <= $teller; $i++) {
                        ...
                        echo '<div class="well" style="margin: 5px;">';
                        echo "<h2>".$order['naam']."</h2>";
                        echo "<h3> aantal: ".$_SESSION['basket'][$i]['amount']."</h3>";
                         echo "<h3> bedrag: ".$order['prijs']*$_SESSION['basket'][$i]['amount']." EURO</h3>";
                        $tot=$tot+$totaal;
                        echo '</div></div>';
                    }
                    echo "<div style='margin-top: 15px;'></div>";
                     echo '<div class="col-md-12">';
                    echo "<h1 style='margin-top: 15px;'>Totaal (incl. BTW): ".$tot." EUR</h1>";
                    echo "</div>";
                    echo "<div style='margin-top: 15px;'></div>";
                ?>    
            </div>
        ...
        <div classs="row" style="margin-top:15px;">
            <div style="margin-left: 15%; margin-right: 15%;margin-bottom: 2%">
                <a href="keuze.php" class="btn btn-block btn-warning">VOLGENDE</a>
                <a href="index.php" class="btn btn-block btn-warning">IETS VERGETEN?</a>
            </div>
        </div>
    </div>
