...
function showOptions()
{
    ...
    echo '<div class="caption">
                    ...
                    <div style="text-align: left">
                              <h3>Jaarlijkse kostprijs: €250</h3>
                    <h3>Domein: beautifulbalance.be</h3>
                    <h3>Naam zaak: beautifulbalance</h3>
                    <h3>Adres: Vissenakensesteenweg 21, 3380 Bunsbeek</h3>
                    <h3>Tel: 016/84.93.21</h3>
                    <h3>Email: dominique.vandermeulen3@telenet.be</h3>
                    </div>
