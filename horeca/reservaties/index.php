...
function toonlijst(){
    ...
    $sql = "SELECT * FROM `reservaties` where created>CURDATE() ORDER BY id desc";
    ...
    foreach ($rij as &$value) {
        ...
        echo '<h3>Email: '.$value['email'].' Tel: '.$value['tel'].'</h3>';
        echo '<h5> '.$value['datum']." ".$value['tijd'].'</h5>';
        echo '<h3>Aantal: '.$value['aantal'].'</h3>';
        
        echo "<textarea class='form-control' disabled>".$value['extra']."</textarea>";
    }
