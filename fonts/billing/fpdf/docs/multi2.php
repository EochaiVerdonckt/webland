...
// Check connection
					...
					if (mysqli_num_rows($result) > 0) {
						...
						echo "0 results GEEN BEHANDELINGEN";
					}
...
// Check connection
	...
	$sql = "
		...
		SELECT d.naam as naam, d.bedrag as bedrag FROM `bill_balance` as b
	LEFT JOIN behandeling_bill_balance as c
        ON b.id=c.factuur
        LEFT JOIN price_balance as d
        ON c.behandeling= d.id
WHERE b.id=".$last;
