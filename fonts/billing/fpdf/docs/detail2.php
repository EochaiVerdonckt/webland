...
if(!is_null($_POST['id']) && is_numeric($_POST['id'])) {
	...
	$bill = getBill($hostname, $usernameDb, $passwordDb, $dbname);
	$nummer = $bill['id'];
	$klant =  getClient($hostname,$usernameDb,$passwordDb,$dbname, $bill['klantid']);
...
function getBill($hostname, $usernameDb, $passwordDb, $dbname)
{
	// Create connection
...
// Check connection
	...
	$sql = "SELECT * FROM bill_balance where id=".$_POST['id'];
...
function getClient($hostname,$usernameDb,$passwordDb,$dbname,$nummer)
{
	// Create connection
	$conn = new mysqli($hostname, $usernameDb, $passwordDb, $dbname);
// Check connection
	...
	$sql = "SELECT * FROM clients_balance where id=".$nummer;
