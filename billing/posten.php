...
if($_POST)
{
    ...
    while ($teller>0)
    {
        $_SESSION['bill']['regel'][$teller]['omschrijving']=$_POST ["omschrijving".$teller];
        $_SESSION['bill']['regel'][$teller]['bedrag']=$_POST ["bedrag".$teller];
        $teller=$teller-1;
    }
    saveBill();
    savePosten();
...
function showOptions($ctrl,$title){
    ...
    <form class="text-left" method="POST" action="" style="margin-left: 2%; margin-right:2%; color: white;width:100%; padding: 10px;">
                 <div>';
                      ...
                      generate_line($_SESSION['bill']['posten']);
