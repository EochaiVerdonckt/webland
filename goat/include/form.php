...
$toemails[] = array(
				'email' => 'm.e@cat-telecom.be', // Your Email Address
				'name' => 'Cat Telecom' // Your Name
			);
...
$fromemail = array(
				'email' => 'no-reply@cat-telecom.com', // Company's Email Address (preferably currently used Domain Name)
