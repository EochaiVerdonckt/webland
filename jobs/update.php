...
function showOptions($ctrl,$title){
    $item=$ctrl->selectStatement('jobs',"id=".$_GET['id']);
    echo "<div class='row'>";
         $ctrl->side_nav();   
        echo "<div class='col-md-9' style=''>";
                ...
                echo '<div style="text-align:left;"><label>Pas hier uw functie aan</label></div>';
                echo  '<input type="text" name="functie" value="'.$item['functie'].'" class="form-control"/>';
