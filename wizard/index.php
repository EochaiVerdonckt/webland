<?php
	if($_POST['msg'])
	{
		// The message
		$message =$_POST['msg']."\r\n"."\r\n";
		$message= $message."Van".$_POST['naam']."\r\n";
		$message= $message."Van".$_POST['mail']."\r\n";
		// In case any of our lines are larger than 70 characters, we should use wordwrap()
		$message = wordwrap($message, 70, "\r\n");
		// Send
		mail('e.verdonckt@live.com', 'Webland home', $message);
	}
...
<body>
    ...
    <section id="welcome">
        <div class="container">
            ...
            <h2>Welkom bij de Webland wizard</h2>
            <hr class="sep">
            <p>Hier kan je in een paar klikken je business bouwen. Deze tool is volledig vrijblijvend.</p>
            <a href="stap1.php" class="btn-block center wow fadeInUp" data-wow-delay=".3s" >Begin</a>
        </div>
    </section>
