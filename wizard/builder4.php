...
<body>
    ...
    <section id="welcome">
        <div class="container">
            ...
            <p>U koos voor domein: <?php echo $_SESSION['domain'] ?> Klik op bestel om uw website en hosting te bestellen. </p>
            <p>U ontvangt een factuur in uw mailbox. Deze omvat enkel de hosting kosten voor 12 maanden.</p>
            <p>Deze factuur bedraagt 60€. Na betaling kan u, een eerste versie van de website bekijken, hierna neemt een consultant contact met u op.</p>
            <div style="margin-bottom: 30px;"></div>
            
            <form method="post" class="wizard" action="account.php">
                    <input type="text" name="domain" value="<?php echo $_SESSION['domain'];?>" class="form-control" readonly >
                    <input type="hidden" name="WebOrder" value="geboekt" />
                   <input type="submit" class="btn btn-success btn-block" value="60€" style="margin-bottom: 1%; margin-top: 1%;">
