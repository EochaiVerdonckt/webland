...
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		{ src:'/slides/service-1.jpg', fade:1000 },
		{ src:'/slides/service-2.jpg', fade:1000 },
		{ src:'/slides/service-3.jpg', fade:1000 }
	  ]
	})();
});
...
$(document).ready(function() {	
	...
	$("#basis").click(function() {
            $( "#message" ).text("Contacteer mij vrijblijvend over het basis pakket");
    });
