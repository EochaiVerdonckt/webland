...
function showOptions()
{
    ...
    echo '<div class="caption">
                    <h1><i class="fa fa-arrow-left"></i></h1>
                     ...
                     <p> <a href="http://mobile-express.be/balance/prijs/" class="btn btn-default" role="button">VORIG</a></p>
                </div>';
...
// Check connection
        ...
        //$sql = "INSERT INTO `product`( `naam`, `info`,`price`) VALUES (,,".."')";
        $sql = "UPDATE `price_balance` SET `bedrag`=".$_POST['price'].",`cat`=".$_POST['categorie'].",`naam`='".$_POST['naam']."' WHERE id=".$_POST['item'];
        if ($conn->query($sql) === TRUE) {
            $_SESSION['input']= "New record created successfully";
            $last = $conn->insert_id;
