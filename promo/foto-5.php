...
// Check connection
    ...
    $sql = "UPDATE `slide_opt` SET `waarde`='".$_POST['button']."' WHERE slide=5 and `naam`='button'";
...
{
    echo '<form action="upload-5.php" method="post" enctype="multipart/form-data">
