...
// Check connection
    ...
    $sql = "UPDATE `slide_opt` SET `waarde`='".$_POST['button']."' WHERE slide=4 and `naam`='button'";
...
{
    echo '<form action="upload-4.php" method="post" enctype="multipart/form-data">
